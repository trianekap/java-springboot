...
public class MataUangController {
    ...
    @PostMapping("/create")
    public ApiResponse<Object> insert(@RequestBody MataUangDto mataUangDto) {
    ...
    public ApiResponse<Object> update(@PathVariable Long id, @RequestBody MataUangDto mataUangDto) throws ResourceNotExistException {
