...
public class PaketTopupController {
    ...
    public ApiResponse<PageResult<PaketTopupDto>> getAllByPage(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int pageSize) {

        PageResult<PaketTopupDto> list;

        try {
            list = paketTopupService.getAllByPage(page, pageSize);
    ...
    @PostMapping("/create")
    public ApiResponse<Object> insert(@RequestBody @Valid PaketTopupDto paketTopupDto) {
    ...
    public ApiResponse<Object> update(@PathVariable Long id, @RequestBody @Valid PaketTopupDto paketTopupDto)
